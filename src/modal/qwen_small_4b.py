"""Run Qwen 3.5 4B through the benchmark pipeline on Modal."""
...
APP_NAME = "isep-qwen-3-5-4b-benchmark"
MODEL_CONFIG_ID = "qwen_3_5_4b"
...
class QwenVllmServer:
    """OpenAI-compatible Qwen 3.5 4B server on one L40S."""

    @modal.enter()
    def start(self) -> None:
        """Start vLLM with thinking disabled and the configured parser."""
...
def main(
    ...
    """Run one benchmark or a fixed smoke suite through one server."""
