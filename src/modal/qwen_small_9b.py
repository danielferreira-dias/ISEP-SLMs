"""Run the repository benchmark pipeline against Qwen 3.5 9B on Modal.
...
APP_NAME = "isep-qwen-3-5-9b-benchmark"
MODEL_CONFIG_ID = "qwen_3_5_9b"
...
class QwenVllmServer:
    """OpenAI-compatible Qwen 3.5 9B server on one L40S."""
